<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('theme-assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{ asset('theme-assets/plugins/summernote/summernote-bs4.min.css') }}">
    <link href="{{ asset('theme-assets/plugins/toastr/build/toastr.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/custom.css') }}" rel="stylesheet" />
    
    {{-- <link rel="icon" type="image/x-icon" href="{{ asset('images/no-delete/dimore_logo.jpg') }}"
